...
left join rrtuat_memorder.sd_bl_so_op_reg_hdr ys on ys.tml_num_id=hdr.tml_num_id and ys.cort_num_id=hdr.cort_num_id
                                                         and hdr.sub_unit_num_id=ys.sub_unit_num_id
left join rrtuat_mdm.mdms_o_sub_unit sub
