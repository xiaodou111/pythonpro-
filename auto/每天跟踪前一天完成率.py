...
file_rrt_o2o= f'{formatted_date}_瑞人堂o2o完成率.xlsx'
# file_tx_o2o = f'{formatted_date}_桐乡o2o完成率.xlsx'
# filename = f'{formatted_date}_销售.csv'
desktop_path = r'D:\download\桌面'
save_path = os.path.join(desktop_path, filename)
save_path2 = os.path.join(desktop_path, filename2)
save_path3 = os.path.join(desktop_path, filename3)
save_rrt_o2o = os.path.join(desktop_path, file_rrt_o2o)
print(f"save_path:{save_path}")
print(f"save_path2:{save_path2}")
print(f"save_path3:{save_path3}")
print(f"save_path3:{save_rrt_o2o}")
...
with open('./sql/rrto2owcl.sql.', 'r', encoding='utf-8') as file:
    rrto2owcl = file.read()
with open('./sql/zsdjwcl.sql.', 'r', encoding='utf-8') as file:
    zsdjwcl = file.read()
...
try:
    conn = get_oracle_prod()
    # 假设你有多个查询和对应的保存路径
    queries = [rrtwlc, txwlc,rrto2owcl]
